...
# ---------------------------------------------------------------------------
# Import app settings and models so that all metadata is populated
# ---------------------------------------------------------------------------
import sys
import os

# Ensure the backend root is on sys.path when running from the project root
...
config.set_main_option(
    "sqlalchemy.url",
    settings.DATABASE_URL.replace("+asyncpg", "+asyncpg", 1),
)
